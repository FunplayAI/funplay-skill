...
For a new game, ask one compact question set before templates or code.
...
- required sections are present: `Intent`, `Core Fun`, `Pillars`, `Core Loop`, `Art Direction`, `Modules`
